...
```
week11/
├── README.md                    # This file (Includes V4 Methodology)
├── assignment.tex               # LaTeX source (Hybrid extraction + Semantic Tracing + Adversarial Audit)
├── assignment.pdf               # Compiled PDF
├── prompt.md                    # Full prompt log
├── synthesis_matrix.md          # Cross-source synthesis matrix
├── audit_table.md               # **V4 Adversarial Verification Audit Protocol**
├── sources/
│   ├── aclu_pr_2024.md             # Source 1: ACLU (Advocacy)
│   ├── dpd_policy_2024.md          # Source 2: DPD Revised Policy (Government)
│   └── dataworks_vendor.md         # Source 3: DataWorks Plus (Industry)
└── annotations/
    ├── aclu_pr_2024_annotated.md   # Annotations
    ├── dpd_policy_2024_annotated.md
    └── dataworks_plus_vendor_annotated.md
```
