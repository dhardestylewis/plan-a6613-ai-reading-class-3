...
My firsthand testing of the chatbot, conducted before its February 2026 shutdown, exposed the system's fatal flaw. When asked straightforward navigational questions, such as how to register a business or find permit applications, the bot produced fluent, confident answers that linked to relevant city resources. The interface felt authoritative: city branding, official language, and a design that simulated bureaucratic authority. But when asked nuanced regulatory questions involving tenant rights, labor law, or zoning compliance, the bot generated confident answers that could not be distinguished from accurate guidance. A small disclaimer noted the system ``may occasionally produce incorrect, harmful or biased content,'' yet the UI offered no way for users to separate accurate statutes from algorithmic fiction (Lecher, 2024). Users were encouraged to report inaccuracies through a feedback form that also asked them to rate their experience from one to five stars, a design choice that treated regulatory misinformation as a customer satisfaction issue (Lecher, 2024). The city stated on the chatbot's page that it would review submitted questions to improve answers and address ``harmful, illegal, or otherwise inappropriate'' content, but would otherwise delete user data within 30 days (Lecher, 2024). The central risk was structural rather than technical: the bot was most dangerous exactly when it appeared most helpful, weaponizing the city's authority behind pure hallucinations.
...
The chatbot was designed to augment, and potentially reduce, the human labor required to deliver business compliance guidance. Standard public-sector AI frameworks pitch automation as labor augmentation: bots handle the rote work, humans handle the edge cases. MyCity inverted this. The system did not reduce municipal labor; it exported unpaid quality-assurance work onto civil society. Rosalind Black at Legal Services NYC had to divert time from her primary responsibilities to test and correct the bot's misinformation after being alerted by journalists (Lecher, 2024). Andrew Rigie, Executive Director of the NYC Hospitality Alliance, reported that a business owner had contacted him regarding the inaccuracies (Lecher, 2024). Community organizations and legal aid providers became involuntary quality assurance teams for a tool that was supposed to make their work unnecessary. The city's own workers at OTI spent two years attempting to salvage the system before its shutdown, representing an ongoing resource drain for a tool that never achieved fitness for purpose (Fast Company, 2024; Vice, 2026).
