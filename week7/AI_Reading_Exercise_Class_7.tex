...
\noindent Google's AI-driven emissions are rising faster than its efficiency gains can offset, and its preferred accounting methodology understates the gap.
...
Claude correctly identified both Environmental Reports, cited emission figures accurately, and named specific mitigation technologies without hallucinating sources or fabricating statistics. The core limitation was one of \textit{framing} rather than fabrication: it accepted Google's market-based accounting without surfacing the location-based alternative, and it presented conditional, pre-GenAI efficiency claims as current achievements. This is precisely the gap that matters for urban planners. Google's emissions have risen 51\% since 2019 by its own market-based measure, yet the IEA's net-zero scenario requires data center emissions to \textit{halve} by 2030 (IEA, 2023). An AI tool that assembles corporate claims without interrogating the accounting methodology behind them cannot help a planner evaluate whether those claims are consistent with climate commitments.
